...
const clubTraining = ({ isFirstMount }) => {
  const content = {
    ...
    Every workout will be fun, challenging and unique!`,
    button3Text: `Transform`,
    link3: "/contact",

    service4Title: `
    SEE REAL RESULTS`,
    service4Text: `Results take patience and consistency.
    Learning proper technique and form takes time.
  ...
  return (
    <motion.section exit={{ opacity: 0 }}>
          ...
          <motion.div className={styles.image}>
            ...
            >
              ...
              >
               ...
               `}
                <br />
                {` Virtual Training is fun, easy, and convenient. Perfect for retirees who want to protect themselves from COVID 19. Follow the steps below.`}
              </motion.p>
            </motion.div>
          </motion.div>
        </motion.div>
      ...
      <ServicesCards serviceType content={content}  threeSections/>
    </motion.section>
  );
};
